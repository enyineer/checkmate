...
var E = Array.isArray, P = Object.prototype.hasOwnProperty, S = { current: null }, x = { key: !0, ref: !0, __self: !0, __source: !0 };
function I(e, t, r) {
  var n, u = {}, c = null, s = null;
  if (t != null) for (n in t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t) P.call(t, n) && !x.hasOwnProperty(n) && (u[n] = t[n]);
...
function _(e, t, r, n, u) {
  ...
  if (s) return s = e, u = u(s), e = n === "" ? "." + m(s, 0) : n, E(u) ? (r = "", e != null && (r = e.replace(j, "$&/") + "/"), _(u, t, r, "", function(a) {
    return a;
  })) : u != null && (g(u) && (u = J(u, r + (!u.key || s && s.key === u.key ? "" : ("" + u.key).replace(j, "$&/") + "/") + e)), t.push(u)), 1;
  if (s = 0, n = n === "" ? "." : n + ":", E(e)) for (var f = 0; f < e.length; f++) {
    c = e[f];
    var i = n + m(c, f);
    s += _(c, t, r, i, u);
  }
  else if (i = W(e), typeof i == "function") for (e = i.call(e), f = 0; !(c = e.next()).done; ) c = c.value, i = n + m(c, f++), s += _(c, t, r, i, u);
...
var l = { current: null }, h = { transition: null }, X = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: h, ReactCurrentOwner: S };
function T() {
  throw Error("act(...) is not supported in production builds of React.");
}
o.Children = { map: d, forEach: function(e, t, r) {
  d(e, function() {
...
o.cloneElement = function(e, t, r) {
  ...
  var n = k({}, e.props), u = e.key, c = e.ref, s = e._owner;
  if (t != null) {
    if (t.ref !== void 0 && (c = t.ref, s = S.current), t.key !== void 0 && (u = "" + t.key), e.type && e.type.defaultProps) var f = e.type.defaultProps;
...
R.exports = o;
var A = R.exports;
const Y = /* @__PURE__ */ M(A), te = /* @__PURE__ */ D({
  __proto__: null,
  default: Y
}, [A]);
export {
